  ...
  return (
    <>
      <Container size={"xs"} py={35} bg={"white"} className="border rounded my-6">
        ...
        <p className="text-sm  font-light pb-4 leading-0">
          No problem. Please type in your account email address and we’ll send you a link to reset
          your password.
        </p>
        <form onSubmit={handleSubmit} className="space-y-2">
          ...
          <Group justify="flex-end">
            <CustomButton loading={loading} disabled={loading} type="submit" color={"blue"}>
              {" "}
